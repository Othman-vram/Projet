...
\addcontentsline{toc}{chapter}{Glossaire des termes techniques}
...
Le pipeline de prétraitement implémente une chaîne de traitement automatisée qui transforme les images brutes en données exploitables par l'application de suture. Cette approche permet un traitement efficace et reproductible des données avec intégration QuPath et plugin SAM pour une segmentation précise.

\subsection{Application desktop de suture}

L'application desktop est développée en Python avec PyQt6, suivant une architecture MVC adaptée aux applications graphiques.
